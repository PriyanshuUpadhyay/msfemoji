    ...
    <>
      ...
      >
        <path
          ...
          fill="url(#paint0_radial_31_1574)"
        />
        <path
          d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
          fill="url(#paint1_radial_31_1574)"
        />
        <path
          d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
          fill="url(#paint2_radial_31_1574)"
        />
        <path
          d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
          fill="url(#paint3_radial_31_1574)"
          fill-opacity="0.6"
        />
        <path
          d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
          fill="url(#paint4_radial_31_1574)"
        />
        <path
          d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
          fill="url(#paint5_radial_31_1574)"
        />
        <path
          d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
          fill="url(#paint6_radial_31_1574)"
        />
        <path
          d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
          fill="url(#paint7_radial_31_1574)"
        />
        ...
        <circle
          ...
          cy="13.5"
          r="4.5"
          fill="url(#paint9_radial_31_1574)"
        />
        <path
        ...
        <path
          ...
          fill="url(#paint10_linear_31_1574)"
        />
        <path
          d="M21 15C22.6569 15 24 13.6569 24 12C24 10.3431 22.6569 9 21 9C19.3431 9 18 10.3431 18 12C18 13.6569 19.3431 15 21 15Z"
          fill="url(#paint11_linear_31_1574)"
        />
        <path
          d="M11.62 21.96C13.5 19 17.42 18.12 20.38 20"
          stroke="url(#paint12_radial_31_1574)"
          stroke-width="2"
          stroke-linecap="round"
        />
        <defs>
          <radialGradient
            id="paint0_radial_31_1574"
            cx="0"
            cy="0"
            r="1"
          ...
          <radialGradient
            id="paint12_radial_31_1574"
            cx="0"
            cy="0"
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="translate(16.9999 25.5) rotate(-96.009) scale(9.55249 9.4252)"
          >
